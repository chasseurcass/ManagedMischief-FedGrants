...
* Licensed clinicians for outpatient treatment
* Peer recovery specialists and related supervision
* Family recovery engagement
...
* Recruitment and training of peer recovery coaches
...
* Educational re-engagement personnel
* Workforce readiness supports
* Basic needs (transportation, clothing, food assistance)
...
* Restitution assistance coordination
* Supervision aides or part-time staff
* Accountability workshops or curricula
* Youth compliance tracking

Each funding stream is restricted to its aligned cost categories, ensuring clarity in spending and elimination of duplication.
...
* BJA treatment and recovery initiatives
* OJJDP reentry, mentoring, and youth development programs
* State-funded juvenile justice supports
* Local partnerships
...
```
                           JRAP BRAIDED FUNDING MODEL
----------------------------------------------------------------------------------
|                          Integrated Reentry and Aftercare                      |
----------------------------------------------------------------------------------

                ┌────────────────────────────────────────────┐
                │                COSSUP (BJA)                │
                │   Treatment Continuity & Recovery Support   │
                └───────────────────────────┬────────────────┘
                                            │
                ...
                ┌────────────────────────────────────────────┐
                │  Protecting Futures / Peer Recovery Coaches│
                │      Family & Youth Peer Recovery Support  │
                └───────────────────────────┬────────────────┘
                                            │
                ...
                ┌────────────────────────────────────────────┐
                │ Mentoring for Youth Affected by Misuse     │
                │     Prosocial & Relational Supports         │
                └───────────────────────────┬────────────────┘
                                            │
                        • Mentor programs
                        • Group mentoring
                ...
                └───────────────────────────┬────────────────┘
                        ...
                        • Cultural provider networks
                        • Community engagement


                ┌────────────────────────────────────────────┐
                │       Juvenile Accountability (16.523)     │
